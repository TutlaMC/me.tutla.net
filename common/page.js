function calculateBasePathFromDataLayer() {
  ...
  code = `
  <div  style="position:fixed; top:0; right:0;background-color: rgba(0, 0, 0, 0.226);width:100%;z-index:999999999999999999;">
      <a class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbarWithBothOptions" aria-controls="navbarWithBothOptions"><i class="fa-solid fa-bars"></i></a>
    </div>
    
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="navbarWithBothOptions" aria-labelledby="navabarWithBothOptionsLabel">
      <div class="offcanvas-header" >
        <h5 class="offcanvas-title" id="navabarWithBothOptionsLabel">TutlaMC</h5>
      ...
      <div class="offcanvas-body" >
            ...
            <ul class="nav nav nav-pills flex-column mb-auto" id="selectors"> 
        ...
        <div class="modal-dialog">
            <div class="modal-content text-center">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="donationModalLabel">Donation</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                <img src="common/imgs/donate.png">
                <p class="text-center">Perks listed on the Discord</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <a href="http://discord.tutla.net" target="_blank"><button type="button" class="btn btn-primary">Join Discord</button></a>
                    <a href="http://shop.tutla.net" target="_blank"><button type="button" class="btn btn-primary">Shop</button></a>
                </div>
